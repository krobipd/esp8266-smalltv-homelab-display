> **Hinweis zu diesem Fork.** Dies ist die Beschreibung des Ursprungsprojekts
> [Times-Z/GeekMagic-Open-Firmware](https://github.com/Times-Z/GeekMagic-Open-Firmware),
> auf dem diese Firmware aufbaut — sie beschreibt **nicht** das Homelab-Display.
> Dafür gilt die [README im Wurzelverzeichnis](../README.md).
> Die Bilder sowie der Ordner `backup/` (serielles Sichern der Werksfirmware) sind hier
> nicht mitgeliefert; beides steht im Ursprungsprojekt.
...
- **SSID:** `GeekMagic`
- **Password:** `smalltv123` (changed in this fork as of v0.2.2; upstream uses `$str0ngPa$$w0rd`)
